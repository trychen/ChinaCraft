...
import unstudio.sinocraft.inventory.ContainerJadeBench;
...
public class GuiJadeBench extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        // this.fontRendererObj.drawString("玉石", this.xSize / 2 + 37 -
        // this.fontRendererObj.getStringWidth(s) / 2, 18, 4210752);
    }

    @Override
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        this.mc.getTextureManager().bindTexture(new ResourceLocation("sinocraft", "textures/gui/jadetable.png"));
