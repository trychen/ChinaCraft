...
public class VaultPlugin {
	...
	public double bankBalance(String name){
		if(economy!=null) return economy.bankBalance(name).balance;
		else return 0;
	}
	...
	public boolean bankDeposit(String name, double amount){
		if(economy!=null) return economy.bankDeposit(name, amount).transactionSuccess();
		else return false;
	}
	...
	public boolean bankHas(String name, double amount){
		if(economy!=null) return economy.bankHas(name, amount).transactionSuccess();
		else return false;
	}
	...
	public boolean bankWithdraw(String name, double amount){
		if(economy!=null) return economy.bankWithdraw(name, amount).transactionSuccess();
		else return false;
	}
	...
	public boolean createBank(String name, OfflinePlayer player){
		if(economy!=null) return economy.createBank(name, player).transactionSuccess();
		else return false;
	}
	...
	public boolean depositPlayer(OfflinePlayer player, double amount){
		if(economy!=null) return economy.depositPlayer(player, amount).transactionSuccess();
		else return false;
	}
