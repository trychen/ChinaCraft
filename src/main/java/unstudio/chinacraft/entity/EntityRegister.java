...
public class EntityRegister {
    public static void init() {
        ...
        EntityRegistry.registerModEntity(EntityThrownFirecracker.class, "Entity_Thrown_Firecracker",
                EntityRegistry.findGlobalUniqueEntityId(), ChinaCraft.instance, 350, 30, true);

        EntityRegistry.registerModEntity(EntityThrownBomb.class, "Entity_Thrown_Bomb",
                EntityRegistry.findGlobalUniqueEntityId() + 1, ChinaCraft.instance, 351, 31, true);
    }
