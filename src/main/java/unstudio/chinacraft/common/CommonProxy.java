...
public class CommonProxy {
    ...
    // registrar.registerBodyProvider(new BuhrimillWailaHandler(),
    // BlockBuhrimill.class);
    // }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        // GameRegistry.registerBlock(ChinaCraft.lanternScaldfishOff,
        // "LanternScaldfish");
        // GameRegistry.registerBlock(ChinaCraft.lanternScaldfishOpenable,
        // "lanternScaldfishOpenable");
        // GameRegistry.registerItem(ChinaCraft.itemLanternScaldfish,
        // "itemLanternScaldfish");
        // GameRegistry.registerItem(ChinaCraft.itemLanternScaldfishOpenable,
        // "itemLanternScaldfishOpenable");
        ...
        // GameRegistry.registerBlock(ChinaCraft.marbleSlab,
        // ItemCCSlab.class,"MarbleSlab",ChinaCraft.marbleSlab,ChinaCraft.marbleDoubleSlab,false);
        // GameRegistry.registerBlock(ChinaCraft.marbleDoubleSlab,
        // ItemCCSlab.class,"MarbleDoubleSlab",ChinaCraft.marbleSlab,ChinaCraft.marbleDoubleSlab,true);
        ...
        // GameRegistry.registerBlock(ChinaCraft.chiseledMarble,
        // "ChiseledMarble");
        // GameRegistry.registerBlock(ChinaCraft.riceGrow, "RiceGrow");
        // GameRegistry.registerBlock(ChinaCraft.woodenWindow1,
        // "WoodenWindow1");// 木窗户
        // GameRegistry.registerBlock(ChinaCraft.woodenWindow2,
        // "WoodenWindow2");
        // GameRegistry.registerBlock(ChinaCraft.woodenWindow3,
        // "WoodenWindow3");
        // GameRegistry.registerBlock(ChinaCraft.woodenWindow4,
        // "WoodenWindow4");
        // GameRegistry.registerBlock(ChinaCraft.woodenWindowdragon,
        // "WoodenWindowDragon"); // 龙腾木窗格
        // GameRegistry.registerBlock(ChinaCraft.woodenWindowfu,
        // "WoodenWindowFu"); // 福字木窗格
        // GameRegistry.registerBlock(ChinaCraft.soyGrow, "SoyGrow");
        // GameRegistry.registerBlock(ChinaCraft.bamboo, "Bamboo"); // 竹子
        // GameRegistry.registerBlock(ChinaCraft.bambooPlank, "BambooPlank"); //
        // 竹木板
        // GameRegistry.registerBlock(ChinaCraft.azalea, "Azalea");
        // GameRegistry.registerBlock(ChinaCraft.peony, "Peony");
        // GameRegistry.registerBlock(ChinaCraft.chrysanthemum,
        // "chrysanthemum");
        ...
        // GameRegistry.registerBlock(ChinaCraft.blockGlutinousRice,
        // "BlockGlutinousRice");
        ...
        // GameRegistry.registerBlock(ChinaCraft.mulberrySapling,
        // "MulberrySapling");
        ...
        // GameRegistry.registerBlock(ChinaCraft.blockitemBambooBambooShoot,
        // "BlockBambooShoot");
        ...
        // GameRegistry.registerBlock(ChinaCraft.blackbrickSlab,ItemCCSlab.class,"BlackBrickSlab",
        // ChinaCraft.blackbrickSlab, ChinaCraft.blackbrickDoubleSlab,false);
        // GameRegistry.registerBlock(ChinaCraft.blackbrickDoubleSlab,ItemCCSlab.class,"BlackBrickDoubleSlab",
        // ChinaCraft.blackbrickSlab, ChinaCraft.blackbrickDoubleSlab,true);
        // GameRegistry.registerBlock(ChinaCraft.blackbrickStair,"BlackBrickStair");

        // GameRegistry.registerBlock(ChinaCraft.jadeWorkingTable,
        // "JadeWorkingTable"); // 玉石工作台
        ...
        // GameRegistry.registerBlock(ChinaCraft.buhrimill, ItemCCBlock.class,
        // "Buhrimill"); // 石磨
        ...
        // GameRegistry.registerBlock(ChinaCraft.cooking_bench_on,
        // "CookingBenchOn");
        // GameRegistry.registerBlock(ChinaCraft.cooking_bench_off,
        // "CookingBenchOff");
        ...
        // GameRegistry.registerBlock(ChinaCraft.potteryTable,
        // ItemCCBlock.class, "PotteryTable"); // 陶瓷工作台
        GameRegistry.registerTileEntity(TilePotteryTable.class, "tileEntityCCPotteryTable");

        // GameRegistry.registerBlock(ChinaCraft.blockPotteryBase, "Pottery");
        // // 陶瓷
        // GameRegistry.registerBlock(ChinaCraft.blockBuckpot, "Buckpot"); // 陶罐

        // GameRegistry.registerItem(ChinaCraft.saltBucket, "SaltBucket");
        // GameRegistry.registerItem(ChinaCraft.douJiangBucket,
        // "DouJiangBucket");
        ...
        // GameRegistry.registerItem(ChinaCraft.copperTinMixedPowder,
        // "CopperTinMixedPowder");
        ...
        // GameRegistry.registerItem(ChinaCraft.bronzeBroadSword,
        // "BronzeBroadSword");// 青铜大刀
        // GameRegistry.registerItem(ChinaCraft.bronzeBroadSwordGreen,
        // "bronzeBroadSwordGreen");// 青铜大刀
        // GameRegistry.registerItem(ChinaCraft.bronzeBroadSwordGreen2,
        // "bronzeBroadSwordGreen2");// 青铜大刀
        // GameRegistry.registerItem(ChinaCraft.bronzeBroadSwordPink,
        // "bronzeBroadSwordPink");// 青铜大刀
        // GameRegistry.registerItem(ChinaCraft.bronzeBroadSwordPurple,
        // "bronzeBroadSwordPurple");// 青铜大刀
        // GameRegistry.registerItem(ChinaCraft.jiuqu_tang, "JiuQuTang");// 九曲镋刀
        // GameRegistry.registerItem(ChinaCraft.mace, "Mace");
        // GameRegistry.registerItem(ChinaCraft.blGiantSword,
        // "YanLungGiantknife");// 炎龙巨刀
        // GameRegistry.registerItem(ChinaCraft.bronzePickaxe,
        // "CCItemPickaxe");// 青铜稿
        // GameRegistry.registerItem(ChinaCraft.bronzeAxe, "CCItemAxe");// 青铜斧
        // GameRegistry.registerItem(ChinaCraft.bronzeHoe, "BronzeHoe");// 青铜锄
        // GameRegistry.registerItem(ChinaCraft.bronzeShovel, "BronzeShovel");//
        // 青铜铲
        // GameRegistry.registerItem(ChinaCraft.hammerStone, "StoneHammer");//
        // 石锤
        // GameRegistry.registerItem(ChinaCraft.hammerIron, "IronHammer");// 铁锤
        // GameRegistry.registerItem(ChinaCraft.hammerBronze,
        // "DiamondBronze");// Bronze锤
        // GameRegistry.registerItem(ChinaCraft.hammerDiamond,
        // "DiamondHammer");// 钻石锤
        ...
        // GameRegistry.registerItem(ChinaCraft.itemMulberryLeaf,
        // "ItemMulberryLeaf");// 桑叶
        // GameRegistry.registerItem(ChinaCraft.woodenBucket, "WoodenBucket");//
        // 木桶
        // GameRegistry.registerBlock(ChinaCraft.blockWoodenBucket,
        // "BlockWoodenBucket");// 木桶(方块)
        ...
        // 1), new Object[]{" ", "# #", " # ", '#',
        // Item.getItemFromBlock(Blocks.wooden_slab)});
        // GameRegistry.registerItem(ChinaCraft.woodenBucket_Water,
        // "WoodenBucket_Water");// 木桶
        // (水)
        // GameRegistry.registerItem(ChinaCraft.silkworm, "Silkworm");// 蚕
        // GameRegistry.registerItem(ChinaCraft.silkwormChrysalis,
        // "SilkwormChrysalis");
        ...
        // GameRegistry.registerItem(ChinaCraft.blackDogBlood,
        // "BlackDogBlood");// 黑狗血
        // GameRegistry.registerItem(ChinaCraft.moonCake, "MoonCake");// 月饼
        // GameRegistry.registerItem(ChinaCraft.artKnife, "ItemArtKnife");//
        // 美工切割刀
        // GameRegistry.registerBlock(ChinaCraft.xinjiangNutCake,
        // "XinjiangNutCake");
        // GameRegistry.registerItem(ChinaCraft.itemXinjiangNutCake,
        // "ItemXinjiangNutCake");
        // GameRegistry.registerBlock(ChinaCraft.appleCake,
        // "BLockAppleCake");//错误命名
        ...
        // 耐火砖
        // GameRegistry.registerBlock(ChinaCraft.blockFirebrickStructure,
        // "blockFirebrickStructure");
        GameRegistry.registerTileEntity(TileFirebrickStructure.class, "tileCCFirebrickStructure");
        // GameRegistry.registerBlock(ChinaCraft.blockPotteryKiln,
        // "blockPotteryKiln");
        GameRegistry.registerTileEntity(TilePotteryKiln.class, "tileCCPotteryKiln");
        // GameRegistry.registerBlock(ChinaCraft.blockFirebrick,
        // "BlockFirebrick");// 耐火砖方块
        // GameRegistry.registerItem(ChinaCraft.firebrick, "Firebrick");// 耐火砖物品
        // GameRegistry.registerItem(ChinaCraft.claySandMixture,
        // "ClaySandMixture");// 粘土沙子混合物
        ...
        // GameRegistry.registerItem(ChinaCraft.spiritualMagicFigures,
        // "SpiritualMagicFigures");
        // GameRegistry.registerItem(ChinaCraft.smfFire,
        // "SpiritualMagicFiguresFire");
        // GameRegistry.registerItem(ChinaCraft.smfNightVision,
        // "SpiritualMagicFiguresNightVision");
        // GameRegistry.registerItem(ChinaCraft.smfPoison,
        // "SpiritualMagicFiguresPoison");
        // GameRegistry.registerItem(ChinaCraft.smfPower,
        // "SpiritualMagicFiguresPower");
        // GameRegistry.registerItem(ChinaCraft.smfHeal,
        // "SpiritualMagicFiguresHeal");
        // GameRegistry.registerItem(ChinaCraft.smfProtect,
        // "SpiritualMagicFiguresProtect");
        // GameRegistry.registerItem(ChinaCraft.smfSuper,
        // "SpiritualMagicFiguresSuper");

        // GameRegistry.registerBlock(ChinaCraft.redCarpet, "red_carpet");
        // GameRegistry.registerBlock(ChinaCraft.silkCarpet, "silk_carpet");

        // disc
        // GameRegistry.registerItem(ChinaCraft.three_stanzas,
        // "three_stanzas_of_plum-blossoms");
        // GameRegistry.registerItem(ChinaCraft.mountain_stream,
        // "mountain_stream");
        // GameRegistry.registerItem(ChinaCraft.the_march_of_the_volunteers,
        // "the_march_of_the_volunteers");
        // GameRegistry.registerItem(ChinaCraft.spring_festival_overture,
