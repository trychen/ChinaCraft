...
import unstudio.chinacraft.block.especial.Cooker;
	   ...
	   public static int getItemBurnTime(ItemStack p_145952_0_)
		...
		public void updateEntity()
	    {
	        ...
	        if (!this.worldObj.isRemote)
	        {
	            ...
	            {
	                flag1 = true;
	                Cooker.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
	            }
	        }
