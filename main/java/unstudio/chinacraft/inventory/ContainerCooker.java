...
import unstudio.chinacraft.block.tileentity.TileCooker;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class ContainerCooker extends Container{

		private TileCooker tile;
		private int lastFurnaceBurnTimet;
		private int lastCurrentItemBurnTime;
		
		public ContainerCooker(InventoryPlayer par1InventoryPlayer, TileCooker tileEntity) {
