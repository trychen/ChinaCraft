package unstudio.chinacraft.mobs;
...
import unstudio.chinacraft.mobs.model.ModelChinaZombie;

@SideOnly(Side.CLIENT)
public class ChinaZombieRenderer extends RenderBiped {
    ...
    public ChinaZombieRenderer()
    {
        super(new ModelChinaZombie(), 0.5F, 1.0F);
